...
public class IDGenerator {
    ...
    //创建自定义id
    public static  String create(int carId, int rmuId, String timestamp) {

        String uuidString = timestamp + carId + rmuId ;
        byte[] uuidByte = uuidString.getBytes();
        UUID uuid = UUID.nameUUIDFromBytes(uuidByte);
